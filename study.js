...
function renderCard(){
 ...
 else{hanzi.textContent=w.hanzi;pinyin.textContent=w.pinyin;meaning.textContent=w.meaning}
 pinyin.classList.add("hidden");meaning.classList.add("hidden");$("showPinyinBtn").textContent="병음 보기 🔊";$("showMeaningBtn").textContent="뜻 보기"
}
